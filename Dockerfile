...
ARG NEXT_PUBLIC_NEXYS_HOME_URL
ARG NEXT_PUBLIC_OTEL_ENDPOINT
ARG NEXT_PUBLIC_OTEL_SERVICE_NAME
ARG NEXT_PUBLIC_OTEL_SAMPLE_RATE
...
ARG NEXT_PUBLIC_OMNIXYS_TENANT_ID
ARG OMNIXYS_TENANT_ID
...
ENV NEXT_PUBLIC_BACKEND_SERVER_URL=$NEXT_PUBLIC_BACKEND_SERVER_URL \
    ...
    NEXT_PUBLIC_NEXYS_HOME_URL=$NEXT_PUBLIC_NEXYS_HOME_URL \
    NEXT_PUBLIC_OTEL_ENDPOINT=$NEXT_PUBLIC_OTEL_ENDPOINT \
    NEXT_PUBLIC_OTEL_SERVICE_NAME=$NEXT_PUBLIC_OTEL_SERVICE_NAME \
    NEXT_PUBLIC_OTEL_SAMPLE_RATE=$NEXT_PUBLIC_OTEL_SAMPLE_RATE \
    NEXT_PUBLIC_FALLBACK_URL=$NEXT_PUBLIC_FALLBACK_URL \
    NEXT_PUBLIC_SENTRY_DSN=$NEXT_PUBLIC_SENTRY_DSN \
    NEXT_PUBLIC_ENVIRONMENT=$NEXT_PUBLIC_ENVIRONMENT \
    NEXT_PUBLIC_SENTRY_REPLAYS_SESSION_SAMPLE_RATE=$NEXT_PUBLIC_SENTRY_REPLAYS_SESSION_SAMPLE_RATE \
    NEXT_PUBLIC_SENTRY_REPLAYS_ON_ERROR_SAMPLE_RATE=$NEXT_PUBLIC_SENTRY_REPLAYS_ON_ERROR_SAMPLE_RATE \
    OMNIXYS_TENANT_ID=$OMNIXYS_TENANT_ID \
    NEXT_PUBLIC_OMNIXYS_TENANT_ID=$NEXT_PUBLIC_OMNIXYS_TENANT_ID
...
RUN --mount=type=secret,id=omnixys_token,env=OMNIXYS_TOKEN \
    echo "@omnixys:registry=https://npm.pkg.github.com" > .npmrc && \
    echo "//npm.pkg.github.com/:_authToken=${OMNIXYS_TOKEN}" >> .npmrc && \
