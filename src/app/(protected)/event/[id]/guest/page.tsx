          ...
          >
            ...
            >
              ...
              >
                ...
                <Chip label={`Gesamt: ${counters2.total}`} sx={{ fontWeight: 700 }} />
          ...
          {guestsFiltered.map((guest) => (
            <Paper
              ...
              sx={{
                p: 2.5,
                borderRadius: 3,
                backgroundColor: highContrast ? omni.backgroundDefault : omni.backgroundPaper,
                border: highContrast ? `2px solid ${omni.primary}` : `1px solid ${omni.secondary}`,
              }}
            >
              <Typography
                sx={{
              ...
              {guest.seat && (
                <Typography
                  ...
                  color={apple.secondaryLabel}
                >
                  {guest.seat.section} · {guest.seat.table} · {guest.seat.number}
                </Typography>
              )}
              ...
              >
                <Chip
                  ...
                  sx={{
                    bgcolor: guest.checkedInAt ? omni.success + "22" : omni.error + "22",
                    color: guest.checkedInAt ? omni.success : omni.error,
                    fontWeight: 700,
                  }}
                />

                <Chip size="small" label={guest.presence === "INSIDE" ? "Drinnen" : "Draußen"} />
              </Stack>
            </Paper>
          ))}
        </Stack>
