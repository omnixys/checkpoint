...
export type WorkspaceChannel = "WHATSAPP" | "IN_APP" | "EMAIL";
...
export function getWorkspaceTone(theme: Theme, channel: WorkspaceChannel) {
  const accent =
    channel === "WHATSAPP"
...
export function getChannelLabel(channel: WorkspaceChannel): string {
  switch (channel) {
    case "WHATSAPP":
      return "WhatsApp";
    case "EMAIL":
...
export function getChannelColor(theme: Theme, channel: WorkspaceChannel): string {
  switch (channel) {
    case "WHATSAPP":
      return "#25D366";
    case "EMAIL":
