    ...
    >
      <Box
        ...
        sx={{
          ...
          border: `1px solid ${
            active ? alpha(theme.palette.primary.main, 0.45) : alpha(theme.palette.divider, 0.35)
          }`,
    ...
    <motion.div whileTap={{ scale: 0.94 }} whileHover={{ scale: 1.06 }}>
      <Box
        ...
        sx={{
          ...
          border: `1px solid ${
            active ? alpha(theme.palette.primary.main, 0.4) : alpha(theme.palette.divider, 0.3)
          }`,
