 ...
 */
export const MotionDialogTransition = forwardRef<HTMLDivElement, MotionDialogTransitionProps>(
  function MotionDialogTransition(props, ref) {
    ...
    return (
      <motion.div
        ref={ref}
        initial={false}
        animate={inProp ? { opacity: 1, scale: 1, y: 0 } : { opacity: 0, scale: 0.85, y: 20 }}
