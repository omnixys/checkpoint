...
export const env = {
  ...
  INVITATION_API: getEnv("NEXT_PUBLIC_INVITATION_API", process.env.NEXT_PUBLIC_INVITATION_API, {
    required: true,
    transform: toHttpUrl,
  }),
  ...
  NEXYS_HOME_URL: getEnv("NEXT_PUBLIC_NEXYS_HOME_URL", process.env.NEXT_PUBLIC_NEXYS_HOME_URL, {
    required: true,
    transform: toHttpUrl,
  }),
  ...
  OMNIXYS_TENANT_ID: getEnv("NEXT_PUBLIC_OMNIXYS_TENANT_ID", process.env.NEXT_PUBLIC_OMNIXYS_TENANT_ID),
} as const;
