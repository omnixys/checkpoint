...
export type Mutation = {
  ...
  sendMessage: Message;
  sendTestMessage: Scalars["Boolean"]["output"];
...
export type Subscription = {
  ...
  whatsappMessageForUser: Message;
};
...
export type AuthUserFragment = {
  ...
  lastName: string;
  email: string;
  roles: Array<RealmRoleType> | null;
};
...
} as unknown as DocumentNode<EventTreeQuery, EventTreeQueryVariables>;
