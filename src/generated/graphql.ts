...
export type GetActiveEventQuery = { __typename: 'Query', event: { __typename: 'EventPayload', id: string, name: string, myRole: UserRoleType | null, settings: { __typename: 'SettingsPayload', allowGuestSeatSelection: boolean, startsAt: any, endsAt: any } | null } | null };
