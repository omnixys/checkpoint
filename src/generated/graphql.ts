...
export type CreateEventMutation = { __typename: 'Mutation', createEvent: { __typename: 'EventPayload', id: string, name: string, owner: string, parentId: string | null, path: string | null, depth: number, createdAt: any, updatedAt: any, myRole: UserRoleType | null, settings: { __typename: 'SettingsPayload', id: string, allowReEntry: boolean, rotateSeconds: number, maxSeats: number, dressCode: string | null, description: string | null, isActive: boolean, startsAt: any, endsAt: any, createdAt: any, updatedAt: any }, timeline: Array<{ __typename: 'EventTimelinePayload', id: string, eventId: string, type: string, timestamp: any, label: string }>, userRoles: Array<{ __typename: 'UserRolePayload', id: string, eventId: string, userId: string, role: UserRoleType }> } };
