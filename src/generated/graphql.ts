...
export type GetAllCallingCodesQuery = {
  __typename: "Query";
  getAllCountries: Array<{
    __typename: "Country";
    name: string;
...
export type CreateEventAddressMutation = {
  __typename: "Mutation";
  createEventAddress: {
    __typename: "EventAddressPayload";
    additionalInfo: string | null;
...
export type DeleteEventAddressByEventIdMutation = {
  __typename: "Mutation";
...
export type GetEventAddressesByEventIdQuery = {
  __typename: "Query";
...
export type GetGeoLocationInfoQuery = {
  __typename: "Query";
  getGeoLocationInfo: {
    __typename: "GeoLocationInfo";
    lat: number | null;
...
export type GeneratePasswordlessOptionsMutation = {
  __typename: "Mutation";
  generatePasswordlessOptions: any;
};
...
export type VerifyGuestSignUpMutation = {
  __typename: "Mutation";
  verifyGuestSignUp: {
    __typename: "GuestSignUpPayload";
    message: string | null;
...
export type VerifyPasswordlessAuthenticationMutation = {
  __typename: "Mutation";
...
export type ListWebAuthnDevicesQuery = {
  __typename: "Query";
...
export type EventTimelineFragment = {
  __typename: "EventTimelinePayload";
  id: string;
  eventId: string;
  type: string;
...
export type EventUserRoleFragment = {
  __typename: "UserRolePayload";
  id: string;
  eventId: string;
  userId: string;
...
export type AddTimeLinesMutation = {
  __typename: "Mutation";
  addTimeLines: {
    __typename: "EventPayload";
    timeline: Array<{
...
export type RemoveTimeLinesMutation = {
  __typename: "Mutation";
  removeTimeLines: {
    __typename: "EventPayload";
    timeline: Array<{
...
export type UpdateTimeLinesMutation = {
  __typename: "Mutation";
  updateTimeLines: {
    __typename: "EventPayload";
    timeline: Array<{
...
export type EventChildrenQuery = {
  __typename: "Query";
  eventChildren: Array<{
    __typename: "EventPayload";
    id: string;
...
export type GetSubEventNameListQuery = {
  __typename: "Query";
  eventChildren: Array<{
    __typename: "EventPayload";
    id: string;
    name: string;
    settings: { __typename: "SettingsPayload"; startsAt: any; endsAt: any } | null;
  }>;
};
...
export type GetEventTreeQuery = {
  __typename: "Query";
  eventTree: {
    __typename: "EventTreePayload";
    rootEvent: { __typename: "EventPayload"; id: string; name: string };
    subEvents: Array<{
      __typename: "EventPayload";
      id: string;
      name: string;
...
export type GetPublicEventTreeQuery = {
  __typename: "Query";
  publicEventTree: {
    __typename: "EventTreePayload";
    rootEvent: { __typename: "EventPayload"; id: string; name: string };
...
export type GetFullEventTreeInfoQuery = {
  __typename: "Query";
  eventTree: {
    __typename: "EventTreePayload";
    rootEvent: { __typename: "EventPayload"; id: string; name: string };
    subEvents: Array<{ __typename: "EventPayload"; id: string; name: string }> | null;
  };
};
...
export type GetEventByIdRsvpQuery = {
  __typename: "Query";
  eventRsvp: {
    __typename: "EventPayload";
    id: string;
...
export type GetActiveEventQuery = {
  __typename: "Query";
  event: {
    __typename: "EventPayload";
    id: string;
    name: string;
    myRole: UserRoleType | null;
    settings: { __typename: "SettingsPayload"; allowGuestSeatSelection: boolean } | null;
  } | null;
};
...
export type GetEventSettingsQuery = {
  ...
  event: {
    ...
    owner: string;
    parentId: string | null;
    userRoles: Array<{ __typename: "UserRolePayload"; role: UserRoleType; userId: string }>;
    timeline: Array<{
      __typename: "EventTimelinePayload";
      id: string;
      eventId: string;
...
export type GetMyEventCalendarDataQuery = {
  __typename: "Query";
  myEvents: Array<{
    __typename: "EventPayload";
    id: string;
    name: string;
    settings: { __typename: "SettingsPayload"; startsAt: any } | null;
  }>;
};

export type InvitationBaseFragment = {
  __typename: "InvitationPayload";
  id: string;
  type: InvitationType;
  firstName: string;
...
export type InvitationContactFragment = {
  __typename: "InvitationPayload";
  phoneNumbers: Array<{
    __typename: "PhoneNumberPayload";
    id: string;
...
export type InvitationPlusOneFragment = {
  __typename: "InvitationPayload";
  id: string;
  firstName: string;
  lastName: string;
...
export type InvitationFullFragment = {
  __typename: "InvitationPayload";
  id: string;
  type: InvitationType;
  firstName: string;
...
export type ApproveInvitationMutation = {
  __typename: "Mutation";
  approveInvitation: {
    __typename: "InvitationPayload";
    id: string;
...
export type BulkApproveInvitationsMutation = {
  __typename: "Mutation";
...
export type CreatePlusOnesInvitationMutation = {
  __typename: "Mutation";
...
export type AddPlusOneMutation = {
  __typename: "Mutation";
  createPlusOnesInvitation: {
    __typename: "InvitationPayload";
    id: string;
...
export type ImportInvitationsMutation = {
  __typename: "Mutation";
  importInvitations: {
    __typename: "ImportInvitationsResult";
    total: number;
...
export type RemoveAllPlusOnesByInvitationIdMutation = {
  __typename: "Mutation";
...
export type RemoveAllPlusOnesMutation = {
  __typename: "Mutation";
  removeAllPlusOnesByInvitationId: Array<{
    __typename: "InvitationPayload";
    id: string;
...
export type RemovePlusOneInvitationMutation = {
  __typename: "Mutation";
...
export type RemovePlusOneMutation = {
  __typename: "Mutation";
  removePlusOneInvitation: {
    __typename: "InvitationPayload";
    id: string;
...
export type ReplyInvitationMutation = {
  __typename: "Mutation";
  replyInvitation: {
    __typename: "InvitationPayload";
    id: string;
...
export type UpdatePlusOnesInvitationMutation = {
  __typename: "Mutation";
...
export type EventInvitationQuery = {
  __typename: "Query";
...
export type MyInvitationsIdQuery = {
  __typename: "Query";
...
export type GetPlusOnesByInvitationQuery = {
  __typename: "Query";
...
export type SeatWithRelationsFragment = {
  __typename: "SeatPayload";
  id: string;
  status: string;
  eventId: string;
...
export type SectionFullFragment = {
  __typename: "SectionPayload";
  id: string;
  eventId: string;
  name: string;
...
export type BulkRenameSectionsMutation = {
  __typename: "Mutation";
  bulkRenameSections: {
    __typename: "BulkRenamePayload";
    success: boolean;
...
export type BulkRenameTablesMutation = {
  __typename: "Mutation";
  bulkRenameTables: {
    __typename: "BulkRenamePayload";
    success: boolean;
...
export type GetSeatByGuestAndEventQuery = {
  __typename: "Query";
...
export type GetSeatInfoListQuery = {
  __typename: "Query";
  getSeatList: Array<{
    __typename: "SeatPayload";
    id: string;
...
export type GetFullSeatInfoListQuery = {
  __typename: "Query";
  getSeatList: Array<{
    __typename: "SeatPayload";
    id: string;
...
export type GetFullSeatInfoQuery = {
  __typename: "Query";
  seat: {
    __typename: "SeatPayload";
    label: string | null;
...
export type ScanResultFragment = {
  __typename: "ScanPayload";
  verdict: ScanVerdict;
  message: string;
  ticket: {
...
export type TicketBasicFragment = {
  __typename: "TicketPayload";
  id: string;
  eventId: string;
  invitationId: string;
...
export type TicketSecurityFragment = {
  __typename: "TicketPayload";
  deviceId: string | null;
  devicePublicKey: string | null;
  deviceActivationAt: any | null;
...
export type TicketFullFragment = {
  __typename: "TicketPayload";
  id: string;
  eventId: string;
  invitationId: string;
...
export type RevokeTicketMutation = {
  __typename: "Mutation";
  revokeTicket: {
    __typename: "TicketPayload";
    id: string;
...
export type GetMyTicketListQuery = {
  __typename: "Query";
...
export type GetMyFullTicketListQuery = {
  __typename: "Query";
  getMyTickets: Array<{
    __typename: "TicketPayload";
    eventId: string;
...
export type SecurityTicketPageQuery = {
  __typename: "Query";
  ticketsByEvent: Array<{
    __typename: "TicketPayload";
    id: string;
...
export type CustomerInterestFragment = {
  __typename: "CustomerInterestPayload";
  id: string;
  customerId: string;
  interestId: string;
...
export type GetSecurityGuestInfoQuery = {
  __typename: "Query";
  getUserList: Array<{
    __typename: "UserPayload";
    id: string;
