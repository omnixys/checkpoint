...
export type GetActiveEventQuery = { __typename: 'Query', event: { __typename: 'EventPayload', id: string, name: string, myRole: UserRoleType | null } | null };
...
export type GetEventSettingsQuery = { __typename: 'Query', event: { __typename: 'EventPayload', id: string, name: string, myRole: UserRoleType | null, owner: string, parentId: string | null, userRoles: Array<{ __typename: 'UserRolePayload', role: UserRoleType, userId: string }>, timeline: Array<{ __typename: 'EventTimelinePayload', id: string, eventId: string, type: string, timestamp: any, label: string }>, coverMedia: { __typename: 'MediaPayload', id: string, url: string, variants: Array<{ __typename: 'MediaVariantPayload', url: string, width: number }> } | null, settings: { __typename: 'SettingsPayload', id: string, allowReEntry: boolean, rotateSeconds: number, maxSeats: number, dressCode: string | null, description: string | null, isActive: boolean, startsAt: any, endsAt: any, createdAt: any, updatedAt: any } | null } | null };
