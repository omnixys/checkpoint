...
> Repository development instructions for **checkpoint** (Next.js Project).
> Stack: nextjs. Generated as part of the Omnixys repository-policy rollout.

## Repository Overview

Omnixys Checkpoint frontend (Next.js 16, MUI, Apollo + codegen, Vitest, Playwright, next-intl).

- Repository path: `projects/checkpoint` (relative to the Omnixys root)
...
src/app (App Router), src/components, src/errors, src/generated, src/hooks, src/lib, scripts/setup-npmrc.js
...
vitest (unit/components) + Playwright e2e; seed: pnpm --dir ../../seed seed

## Repository-Specific Rules

Keep the generated `<!-- BEGIN:nextjs-agent-rules -->` block in AGENTS.md intact. Playwright projects are infrastructure-dependent.
